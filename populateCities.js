...
},
{
    ...
    country: 'Argentina',
    photo: 'http://drive.google.com/uc?export=view&id=1urCQm9DnoQRoUrM930FzWcE-8uTljV5W',
    population: 593337,
    fundation: '1874',
    description: `Mar del Plata is a city on the coast of the Atlantic Ocean, in Buenos Aires Province, Argentina. Is the second largest city in Buenos Aires Province. The name "Mar del Plata" is a shortening of "Mar del Rio de la Plata," and has the meaning of "sea of the Rio de la Plata basin" or "adjoining sea to the (River) Plate region".Mar del Plata is one of the major fishing ports and the biggest seaside beach resort in Argentina.
    Mar del Plata is the most popular destination for conventions in Argentina after Buenos Aires. Mar del Plata has a wide range of services in this sector. The summer season hosts over fifty theatrical plays. It has a wide variety of clubs located by district: the area of Escollera Norte (known for its quantity of pubs and nightclubs) and Constitution Avenue. It counts with a some mouseams as The Juan Carlos Castagnino Municipal Museum of Art, The Museum of the Port of Mar del Plata Cleto Ciocchini, The Museum of Contemporary Art MAR.`
},
{
    city: 'Villa Carlos Paz',
    province: 'Córdoba',
    country: 'Argentina',
    photo: 'http://drive.google.com/uc?export=view&id=1gMnu_BicwghU1IRiEEPFFdoynemhdvpX',
    population: 75315,
    fundation: '1913',
    description: `Villa Carlos Paz is a city in the center-north of the province of Córdoba, Argentina, in the south of the Punilla Valley, lying on the western slope of the Sierras Chicas. The area of Punilla is a major tourist destination on the national level, and Villa Carlos Paz is in turn the most important city of Punilla, favoured by its closeness to the populous Córdoba City, the capital of the province. Popular tourist activities include bathing in one of the many rivers, fishing, evening shows, kite surfing, windsurfing, hiking and mountain biking.`
},
{
    city: 'Barreal',
    province: 'San Juan',
    country: 'Argentina',
    photo: 'http://drive.google.com/uc?export=view&id=1wtwxG6lKVffjC545ctIXbAY3LMqZ-1-x',
    population: 5398,
    fundation: '1866',
    description: `Barreal is a town belonging to the Calingasta department, located in the far south west of the province of San Juan in the geographic region of Cuyo.
    Located on the right bank of the Río de los Patos, Barreal is dominated by a landscape that is both foothills and mountain ranges, where natural vegetation is relatively scarce. It is also recognized for its comfortable climate, the friendliness of its people, the purity of its air; Its leafy poplar groves and the beauty of its nature make this town a true Andean paradise, increasingly visited by national and foreign tourists. It has been rated by an English-language tourist guide as one of the ten most beautiful places in Argentina.
    Is closed to National Park "El leoncito", which is located on the western slopes of the Sierra del Tontal. The lack of atmospheric pollution in this isolated place and the dry weather guarantee at least 300 days of unmatched sky transparency per year, making it particularly suitable for astronomy research: within the park there are two astronomical observatories: the Leoncito Astronomical Complex (CASLEO) and the Félix Aguilar Observatory (2,552 m (8,373 ft) above sea level)
